...
## 2018/04/19
* [Synthetic data generation for Indic handwritten text recognition](https://arxiv.org/pdf/1804.06254.pdf)
* [DetNet: A Backbone network for Object Detection](https://arxiv.org/pdf/1804.06215v2.pdf)
* [A Concatenated Residual Network for Image Deblurring](https://arxiv.org/pdf/1804.06042.pdf)
* [Real-Time Rotation-Invariant Face Detection with Progressive Calibration Networks](https://arxiv.org/pdf/1804.06039.pdf)
* [Densely Connected High Order Residual Network for Single Frame Image Super Resolution](https://arxiv.org/pdf/1804.05902.pdf)
* [Robust Physical Adversarial Attack on Faster R-CNN Object Detector](https://arxiv.org/pdf/1804.05810.pdf)
* [Training convolutional neural networks with megapixel images](https://arxiv.org/pdf/1804.05712.pdf)
* [Optimizing Video Object Detection via a Scale-Time Lattice](https://arxiv.org/pdf/1804.05472.pdf)
* [SparseNet: A Sparse DenseNet for Image Classification](https://arxiv.org/pdf/1804.05340.pdf)
* [Beyond Trade-off: Accelerate FCN-based Face Detector with Higher Accuracy](https://arxiv.org/pdf/1804.05197.pdf)
